...
const translations = {
  en: {
    ...
    "hero.text.one": "I come from Canton City, Kwongtung Province of China, and I am a Data Science student with a solid engineering foundation from SUSTech and a graduate student at CMU’s Heinz College. My passion lies in developing reliable, agentic AI systems that bridge the gap between complex data and actionable insights.",
  ...
  zh: {
    ...
    "hero.eyebrow": "自我介绍",
    "hero.text.one": "我来自中国广东广州，是一名数据科学学生，本科阶段在南方科技大学打下了扎实的工程基础，目前也将于 CMU Heinz College 深造。我的兴趣在于开发可靠的智能体 AI 系统，把复杂数据转化为可行动的洞察。",
  ...
  es: {
    ...
    "hero.text.one": "Vengo de Cantón, provincia de Guangdong, China. Soy estudiante de Ciencia de Datos con una sólida base de ingeniería de SUSTech y estudiante de posgrado en CMU Heinz College. Me interesa desarrollar sistemas de IA agéntica, fiables, que conecten datos complejos con ideas accionables.",
